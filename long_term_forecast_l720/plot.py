...
def plot_flow(settings):
    ...
    if settings is not None:
        PRED_NAME = settings
        predictions = np.load(f"results/{settings}/pred.npy")
    else:
        PRED_NAME = config[
            'pred_file_name']  # Use the name of the pred.npy file you want to plot (inside results/npy_results/)
